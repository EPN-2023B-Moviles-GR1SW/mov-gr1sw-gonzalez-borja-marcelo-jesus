...
class GGoogleMapsActivity : AppCompatActivity() {
    ...
    fun escucharListeners() {
        ...
        mapa.setOnCameraMoveListener{
            Log.i("mapa", "setOnCameraloveListener")
        }
            ...
            val polilineaUno = mapa
                .addPolyline(
                    PolylineOptions()
                        .clickable(true)
                        .add(
                            LatLng(-0.1759187840647396, -78.48506472421384),
                ...
                .addPolygon(
                    PolygonOptions()
                        ...
                        .add(
                            ...
                            LatLng(-0.17718958124147777, -78.48142892291516)
                        )
                )
    ...
    fun moverQuicentro() {
        ...
        val quicentro = LatLng(
            -0.17556788498271892, 78.48814981143776
        )
